        ...
        <div class="content-wrapper pt-0">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <select id='selectFoster' class="filter location-search" autocomplete="off" placeholder="Selecteer pleeggezin..." multiple data-silent-initial-value-set="true">
                                @foreach ($fosterFamilies as $fosterFamily)
                                    <option value='{{$fosterFamily->id}}'>{{$fosterFamily->firstName}} {{$fosterFamily->lastName}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-footer card-border-danger">
                                            ...
                                            @if ($cat->fosterFamily_id != null)
                                                ...
                                                <div><a href="" class="text-black"><u>{{$cat->fosterFamily->firstName }} {{$cat->fosterFamily->lastName }}</u></a></div>
