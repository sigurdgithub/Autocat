...
<div class="content-wrapper pt-0">
    {{-- FosterFamily Form --}}
    @auth
    <form id="updateForm" method="POST" action="/pleeggezinAccount/{{$fosterFamily->id}}"> @csrf <input type="hidden" value="{{$fosterFamily->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input type="number" min="0" class="form-control" name="availableSpots"
                            value="{{old('availableSpots')}}{{$fosterFamily->availableSpots ?? ''}}">
                    </div>
                </div>
    ...
    <button type="submit" class="btn btn-gradient-info float-end mt-5"
            @if(Auth::check()) form="updateForm" @else form="registerForm" @endif >
