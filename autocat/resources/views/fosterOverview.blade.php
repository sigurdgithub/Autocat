        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-5">
                    ...
                    <div class="col-md-4">
                        <select id='catPreferences' class="fosterFilter" multiple
                            placeholder="Selecteer katvoorkeur(en)...">
                            ...
                            <div class="card">
                                <div class="card-header bg-gradient-info">
                                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute"
                                        alt="circle-image" />
                                    <h4 class="font-weight-normal mb-3"><b>{{$fosterFamily->firstName}}
                                            {{$fosterFamily->lastName}}</b></h4>
                                </div>
                                @php
